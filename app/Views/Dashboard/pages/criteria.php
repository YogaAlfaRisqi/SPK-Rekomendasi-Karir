    ...
    <table class="table table-striped table-hover table-bordered align-middle mb-0">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>@twitter</td>
          <td class="text-center">
            <a href="<?= base_url('your-controller/edit/3') ?>" class="btn btn-sm btn-outline-primary me-1" title="Edit">
              <i class="bi bi-pencil"></i>
            </a>
            <a href="<?= base_url('your-controller/delete/3') ?>" class="btn btn-sm btn-outline-danger" title="Delete" onclick="return confirm('Are you sure want to delete this item?');">
              <i class="bi bi-trash"></i>
            </a>
          </td>
        </tr>
